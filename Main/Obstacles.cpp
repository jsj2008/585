...
Obstacles::Obstacles():
rockModel("textures/map1.png", "", "models/obstacles/groundRock1.obj", 40),
largeRock(rockModel.model, 40),
rockModel2("textures/map1.png", "", "models/obstacles/groundRock2.obj", 40),
largeRock2(rockModel2.model, 40),
rockModel3("textures/map1.png", "", "models/obstacles/groundRock3.obj", 40),
largeRock3(rockModel3.model, 40),
logModel("textures/map1.png", "", "models/obstacles/logBranch.obj", 30),
log(logModel.model, 30),
smallRockModel("textures/map1.png", "", "models/obstacles/fallingRock1.obj", 50),
smallRock(smallRockModel.model, 50),
smallRockModel2("textures/map1.png", "", "models/obstacles/fallingRock2.obj", 50),
